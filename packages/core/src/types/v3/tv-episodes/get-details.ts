...
export type TVEpisodesGetDetailsResponse<AppendToResponse extends TVEpisodesAppendToResponse[] | undefined> =
    TVEpisodesGetDetailsBaseResponse
    & AppendToResponseType<AppendToResponse, "tv_episodes">;
